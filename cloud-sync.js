...
(function () {
  ...
  function injectStyles() {
    var css = ''
      ...
      + 'border:1px solid #cdd4dd;color:#1c293a;font:600 12.5px/1 system-ui,sans-serif;'
      ...
      + '.ff-pill.in{background:#113564;color:#fff;border-color:#113564;}'
      + '.ff-modal{position:fixed;inset:0;background:rgba(8, 15, 24, .55);display:flex;align-items:center;'
      ...
      + '.ff-card h3{margin:2px 0 4px;font-size:20px;color:#14243a;}'
      + '.ff-card p{margin:0 0 16px;font-size:13px;color:#5a6b60;line-height:1.5;}'
      + '.ff-card input{width:100%;box-sizing:border-box;font-size:16px;padding:12px 14px;border:1.5px solid #cdd4dd;'
      + 'border-radius:10px;margin-bottom:12px;}'
      + '.ff-card button.go{width:100%;background:#113564;color:#fff;border:0;border-radius:10px;'
      ...
      + '.ff-msg.ok{color:#113564;} .ff-msg.err{color:#c0392b;}'
