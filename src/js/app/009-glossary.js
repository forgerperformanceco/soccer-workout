  ...
  var FF_TERMS={
    octane:   { ic:"⛽", t:"Octane", d:"Your engine score, 0–100. Six pillars — showing up, jump/sprint power, strength, power-to-weight, mobility and fuel — blended into one number. E is empty, F is full. Tap any pillar on Stats to see exactly what moves it." },
    banked:   { ic:"✅", t:"Banked", d:"Done and saved. A banked meal, session or match is in your history and already counting toward your trends — nothing else to do." },
    ...
    season:   { ic:"🗺️", t:"20-week season", d:"Your training campaign: build waves, heavy waves, planned deloads, and a 2-week peak — all aimed at adding muscle while keeping your speed (and peaking for a big match, if you set one)." },
    ...
    deload:   { ic:"🪫", t:"Deload week", d:"A planned easy week — one set less, ~60% loads. It isn’t lost time: recovery is when adaptation lands. A great week to line up with a big match or tournament." },
    scorecard:{ ic:"🗒️", t:"Sunday Scorecard", d:"Your week as a scorecard — six marks: sessions, iron moved, jump test, weigh-ins, mobility and fuel days. Close it out on Sundays; share it when it’s good." },
    receipts: { ic:"🧾", t:"Receipts", d:"Proof from your own data that the training is working — your jump and strength trend, and how you move on training weeks vs off weeks. They appear once you’ve banked a few weeks." },
    carry:    { ic:"🦵", t:"Vertical jump", d:"How high you jump from a standstill (inches) — the app’s headline power number and the #1 field predictor of sprint speed. Test it every 2 weeks." },
    speedtest:{ ic:"🎯", t:"Jump Test Day", d:"Every 2 weeks: warm up, take 3 max-intent vertical jumps, keep the best (inches). Same method every time, so the trend is honest. More inches means more power into every sprint and cut." },
    p2w:      { ic:"⚖️", t:"Power-to-weight", d:"Your jump and sprint power relative to bodyweight. Mass only helps when it still moves fast — this pillar keeps a bulk honest." },
  ...
  function openTerm(key){
    ...
    m.innerHTML='<div class="qsheet-card"><div class="qsheet-grab"></div>'+
      ...
      '<button type="button" class="term-all" data-termall="1">📖 See all MatchFit terms</button></div>';
    m.hidden=false; document.body.style.overflow="hidden";
  }
  function openGlossary(){
    var m=ffTermSheet();
    m.innerHTML='<div class="qsheet-card"><div class="qsheet-grab"></div>'+
      '<div class="qsheet-h">📖 The MatchFit dictionary</div>'+
  ...
  function ffLoopHtml(){
    var steps=[
      ...
      ["⚽","Play & log matches","where the proof shows up"],
      ["📈","Octane climbs","and the speed follows"]
    ];
  ...
  function openLoop(){
    var m=ffTermSheet();
    m.innerHTML='<div class="qsheet-card"><div class="qsheet-grab"></div>'+
      '<div class="qsheet-h">🔁 How MatchFit works</div>'+
